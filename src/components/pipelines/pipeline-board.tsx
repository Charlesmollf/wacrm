...
export function PipelineBoard({
  ...
  return (
    ...
    >
              <div className="pipeline-scroll flex h-[calc(100svh-11rem)] min-h-[420px] snap-x snap-mandatory items-stretch gap-3 overflow-x-auto pb-16 sm:h-[calc(100vh-16rem)] sm:pb-4 lg:snap-none">
...
function StageColumn({
  ...
  return (
        <div className="flex h-full w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col overflow-hidden rounded-xl border border-border bg-card/60 p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      <div
      ...
      <div
        ref={setNodeRef}
                className={`pipeline-col-scroll mt-3 flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden rounded-lg pr-1 transition-all ${
          isOver
