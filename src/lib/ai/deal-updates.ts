...
export const DEAL_EXTRACTION_INSTRUCTIONS =
  ...
  'ACCESORIO SIEMPRE EXPLICITO EN EL COMBO: el campo combo debe terminar diciendo que accesorio lleva, siempre, sin excepcion: + prensa francesa, + cafetera italiana, o sin accesorio. Ejemplos: combo=Africa Mia + prensa francesa / combo=Procesos Secretos sin accesorio / combo=Mitico Coban + cafetera italiana. La tostaduria arma la caja leyendo ESTE TEXTO, no el precio: si no lo dices, lo adivina por el monto y manda el accesorio equivocado. Ya paso con clientes reales. ' +
